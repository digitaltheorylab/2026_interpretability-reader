...
This course is intended to be a general introduction and makes no assumptions
about participant backgrounds (familiarity with programming, experience in
natural language processing, etc.). It will walk participants through
everything they need to know to complete each session.
